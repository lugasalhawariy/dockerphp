...
np.seterr(divide="ignore") # ignore the warning of zero division; or.. np.seterr(divide="ignore",
invalid=("ignore")
# initial solution you'd like to start at
x = 2 # initial x
y = 1 # initial y
# the himmelblau function dengan objective function value for x and y
