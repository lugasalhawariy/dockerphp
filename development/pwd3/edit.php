...
// update user data
$result = @mysqli_query($con, "UPDATE user SET nama='$nama',jkel='$jkel',alamat='$alamat',tgllhr='$tgllhr' WHERE nim='$nim'");
...
$result = @mysqli_query($con, "SELECT * FROM user WHERE nim='$nim'");
