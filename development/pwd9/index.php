...
echo "<td>".$user_data['nim']."</td>"; echo "<td>".$user_data['nama']."</td>"; echo "<td>".$user_data['jkel']."</td>"; echo "<td>".$user_data['alamat']."</td>"; echo "<td>".$user_data['tgllhr']."</td>";
...
<!-- function cetak -->
<button>
    <a href="lap_mhs.php" style="text-decoration: none; color: black;">Download</a>
</button>
</body>
</html>
